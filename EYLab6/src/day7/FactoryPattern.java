...
class LeatherShoe extends Shoe{
	...
	public String toString() {
		...
		return "This is leather shoe made by Puma...:";
	}
}
class SportsShoe extends Shoe{
	...
	public String toString() {
		// TODO Auto-generated method stub
		return "This is sports shoe made by Adida...";
	}
}
...
class PumaShoeFactory extends ShoeFactory{
	@Override
	public Shoe makeShoe() {
		return new LeatherShoe();
	}
}
class AdidasShoeFactory extends ShoeFactory{
	@Override
	public Shoe makeShoe() {
...
class SaiShoeShop extends ShoeShop{
	@Override
	public Shoe sellShoe(Customer customer) {
		// TODO Auto-generated method stub
