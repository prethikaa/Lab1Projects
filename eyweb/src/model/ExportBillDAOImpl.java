...
public class ExportBillDAOImpl implements ExportBillDAO,Cloneable{
	...
	public void createXML(int invno, TotalDetails totaldetails) {
		try {
			...
			sb.append("</items></invoice>");
					...
					File output = new File("C:\\Users\\Prethikaa Madhan\\eclipse-workspace\\eyweb\\"+invno+".xml");
	...
	public void createPDF(int invno, String invdate) {
		try {
			...
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\Prethikaa Madhan\\eclipse-workspace\\eyweb\\"+invno+".pdf"));
		    document.open();
			...
			Document doc=db.parse("C:\\Users\\Prethikaa Madhan\\eclipse-workspace\\eyweb\\"+invno+".xml");
	...
	public void createExcel(int invno, String invdate) {
		...
		try {
			System.out.println("hi create excel");
			String[] arr=new String[100];
			HSSFWorkbook wb = new HSSFWorkbook();   
			OutputStream fileOut = new FileOutputStream("C:\\Users\\Prethikaa Madhan\\eclipse-workspace\\eyweb\\"+invno+".xls");   
	...
	public void sendMail(String name,String email,int invno) {
		...
		attachmentPart.attachFile(new File("C:\\Users\\Prethikaa Madhan\\eclipse-workspace\\eyweb\\"+invno+".pdf"));
	...
	public void sendSMS(String phone, TotalDetails totaldetails) {
		...
		final String AUTH_TOKEN = "dbd06fe0a8341ca9d7a341b2886af18f";
